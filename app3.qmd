...
**Note:** If you would like to include information on scientific names that is not provided in The Key to Scientific Names (at the bottom of the Systematics page), please add it to the Systematics History section.
...
**For all subsections** on the Distribution page, the following terminology on occurrence may be helpful. **Be sure to give the relevant range of months if discussing seasons (i.e., spring, summer, fall, winter):**
...
**For resident species**, start with a general description using the habitat categories and subcategories defined by Campbell et al. (2021) in the book *Habitats of the World* (described under Habitat Categories below), and then cover more specific details as needed. For example, characterize the habitat in terms of its latitudinal and elevational range and climatic limits, and describe the topography, substrate, and vegetation (including stages of growth and/or plant succession, dominant species and status, and spacing). Note, you may feel free to elaborate beyond the categories below.
...
Sounds produced by the bill, the wings, or the tail should be treated in the same general way as vocalizations, as appropriate and as information exists.
...
Most of the subsections in this section (see [Appendix 2](https://birds-of-the-world.github.io/birds-of-the-world/app2.html)) are self-explanatory. “Collisions” includes birds striking lighthouses and other tall buildings, electrical wires, TV towers, and windows, as well as being hit by cars, planes, boats, etc. For each appropriate subsection for which there is information, describe the locations and times of year and manner in which the mortality occurs, and the number of individuals killed, if known. If a subsection has been discussed in another section, refer the reader there and briefly summarize, but do not repeat, all of the information here.

### [Management]{style="color:blue;"} {#sec-app3-conservation-management}

Most of the subsections (see [Appendix 2](https://birds-of-the-world.github.io/birds-of-the-world/app2.html))in this section are self-explanatory.
...
Describe how the specieshas been recorded in human history, including archaeological evidence of the species interacting with humans before recorded history.

**Presence in Folklore, Religion, and Symbolism**

Discuss appearances of the species in different cultures’ religions and folklore and any symbolic uses of the species (such as designation as a national bird).

**Depictions in Media**

Mention depictions of the species in media, art, literature, etc., and the social impact of those depictions.

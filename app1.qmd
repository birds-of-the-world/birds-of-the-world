...
Content created under contract with HBW was completed and compensated according to those original agreements. Those contractual obligations were concluded with HBW and do not transfer to BOW. While BOW greatly values the expertise of these authors and welcomes their continued involvement, BOW is not obligated to include former HBW-contracted authors in content revisions. Former HBW authors will need to be an active contributor to be involved in future work on the project, and any new contributions to BOW by former HBW-contracted authors would be considered voluntary and subject to the volunteer contributor policies.
...
-   The contributor does not have a valid Contributor Agreement on file

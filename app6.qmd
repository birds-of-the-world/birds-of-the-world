...
-   **Allopatric:** Describes taxa that occur in different locations and whose ranges do not overlap.
...
-   **Parapatric:** Describes taxa whose ranges are adjacent but do not overlap significantly.
...
-   **Sympatric:** Describes taxa that occur in the same location.
...
-   **Syntopic:** Describes taxa that occur in the same habitat at the same time; this term is often used for closely related species.

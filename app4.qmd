...
-   Any bird species mentioned in an account should be included using the Species Name button (or “species tag”).
    -   The default species is the species whose account you are editing. To include the name of any other species, type the name into the search bar and click on the desired species.

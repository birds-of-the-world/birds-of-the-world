...
-   When citing a specimen record, an eBird checklist, or a xeno-canto recording, please use the following format (note the hyperlinks). Note that these are not formal references and therefore should **not** be added to the bibliography:
